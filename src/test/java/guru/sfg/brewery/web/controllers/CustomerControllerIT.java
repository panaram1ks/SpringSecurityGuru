...
public class CustomerControllerIT extends BaseIT {
    ...
    @MethodSource("guru.sfg.brewery.web.controllers.BeerControllerIT#getStreeamAdminCustomer")
    void testListCustomersAUTH(String user, String pwd) throws Exception {
        mockMvc.perform(
                        get("/customers").with(httpBasic(user, pwd))
                )
...
//        }
        ...
        void processCreationFormNOTAUTH() throws Exception {
            mockMvc.perform(post("/customer/new").param("customerName", "Foo Customer"))
                    .andExpect(status().isUnauthorized());
        }
